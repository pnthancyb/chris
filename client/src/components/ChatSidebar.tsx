            ...
            conversations.map((conversation: Conversation) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-3 py-2 text-left text-sm"
                >
                ...
                <div
                  ...
                  className="opacity-0 group-hover:opacity-100 p-1 hover:bg-slate-200 rounded transition-all cursor-pointer absolute right-2 top-1/2 transform -translate-y-1/2"
                >
                  <X className="w-3 h-3" />
                </div>
              </motion.div>
